...
<div align="center"> 
  <a href="https://youtube.com/@Tohidkhan_6332"> 
    <img src="https://github.com/puttus-das/PUTTUS-AI/blob/main/assets/puttus_bot_image_png.png" alt="PUTTUS-AI" height="300"> 
  </a> 
</div>

<div align="center">

<img src="https://komarev.com/ghpvc/?username=puttus-das&label=Profile+Views&color=success&style=flat-square" />
<img src="https://img.shields.io/github/stars/puttus-das/PUTTUS-AI?color=blue&style=yellow-square" />
<img src="https://img.shields.io/github/forks/puttus-das/PUTTUS-AI?color=ff00ff&style=flat-square" />
<img src="https://img.shields.io/github/repo-size/puttus-das/PUTTUS-AI?color=success&style=flat-square" />
<img src="https://img.shields.io/github/last-commit/puttus-das/PUTTUS-AI?color=yellow&style=flat-square" />
...
---
 <p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Orbitron&weight=600&size=24&duration=4000&pause=1000&color=FF0000&center=true&vCenter=true&width=500&lines=PUTTUS+AI+WHATSAPP+BOT;MULTI-DEVICE+SUPPORT;POWERED+BY+BAILEYS;FAST++SECURE++RELIABLE" alt="Typing SVG"/>
</p>
...
<div align="center">
  <a href="https://pairing-web-puttus.vercel.app/pair" target="_blank">
...
<div align="center">
  ...
  <a href="https://whatsapp.com/channel/0029Vb7pmbEEwEjzdGSM4G3B">
...
The PUTTUS AI WhatsApp Bot assists group admins by providing them with tools to efficiently manage large WhatsApp groups. The bot uses the Baileys library to interact with the WhatsApp Web API and supports multi-device features.
...
```
```
git clone https://github.com/<your gitHub Username>/PUTTUS-AI
cd PUTTUS-AI
```
```
...
- Note if npm throws error just exit from ubuntu terminal and login again then `cd PUTTUS-AI && npm install`


## License

This project is licensed under the [MIT License](https://opensource.org/licenses/MIT) - see the [LICENSE](https://github.com/puttus-das/PUTTUS-AI/blob/main/LICENSE) file for details.

---

## Contributions

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/puttus-das/PUTTUS-AI/issues).

---

## 🌟 Show your support

If you like this project, please give it a [⭐️ star on GitHub](https://github.com/puttus-das/PUTTUS-AI)!


## Credits

| [![APURBO](https://github.com/puttus-das.png?size=100)](https://github.com/puttus-das) | [![WhiskeySockets](https://github.com/WhiskeySockets.png?size=100)](https://github.com/WhiskeySockets) |
| --- | --- 
| [APURBO](https://github.com/puttus-das) |[WhiskeySockets](https://github.com/WhiskeySockets) |
...
Copyright (c) 2026 puttus-das. All rights reserved.
