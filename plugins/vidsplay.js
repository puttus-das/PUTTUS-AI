    ...
    try {
      ...
      if (imageUrl) {
        await sock.sendMessage(
          chatId,
          { image: { url: imageUrl }, caption: "🖼️ Vidsplay Thumbnail" },
          { quoted: message },
        );
      }
      ...
      if (videoUrl) {
        await sock.sendMessage(
          chatId,
          { video: { url: videoUrl }, caption: "🎬 Vidsplay Video" },
          { quoted: message },
        );
      }
    } catch (error) {
      ...
      if (error.code === "ECONNABORTED") {
        ...
        await sock.sendMessage(
          chatId,
          { text: "❌ Failed to fetch Vidsplay video." },
          { quoted: message },
        );
      }
    }
