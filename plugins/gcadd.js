...
• Reply to a message with \`.add\``,
    ...
    if (
      !targetNumber.startsWith("1") &&
      !targetNumber.startsWith("2") &&
      !targetNumber.startsWith("3") &&
      !targetNumber.startsWith("4") &&
      !targetNumber.startsWith("5") &&
      !targetNumber.startsWith("6") &&
      !targetNumber.startsWith("7") &&
      !targetNumber.startsWith("8") &&
      !targetNumber.startsWith("9")
    ) {
      return await sock.sendMessage(
        chatId,
        {
          text: "❌ *Invalid number format!*\n\nPlease include the country code.\nExample: 918967360566",
          ...channelInfo,
        },
        { quoted: message },
      );
