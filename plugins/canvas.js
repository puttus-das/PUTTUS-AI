...
async function getQuotedOrOwnImageUrl(sock, message) {
  ...
  try {
    ...
    return "https://files.catbox.moe/fhifrt.jpeg";
  }
}
      ...
      switch (sub) {
        ...
        case "its-so-stupid": {
          ...
          if (!dog) {
            await sock.sendMessage(
              chatId,
              { text: "❌ *Usage:* `.canvas its-so-stupid <text>`" },
              { quoted: message },
            );
            return;
          }
        ...
        case "namecard": {
          ...
          if (!username || !birthday) {
            await sock.sendMessage(
              chatId,
              {
                text: "❌ *Usage:* `.canvas namecard username|birthday|description(optional)`",
              },
              { quoted: message },
            );
            return;
        ...
        case "tweet": {
          ...
          if (!displayname || !username || !comment) {
            await sock.sendMessage(
              chatId,
              {
                text: "❌ *Usage:* `.canvas tweet displayname|username|comment|theme(optional)`",
              },
              { quoted: message },
            );
            return;
        ...
        case "youtube-comment": {
          ...
          if (!username || !comment) {
            await sock.sendMessage(
              chatId,
              {
                text: "❌ *Usage:* `.canvas youtube-comment username|comment`",
              },
              { quoted: message },
            );
            return;
