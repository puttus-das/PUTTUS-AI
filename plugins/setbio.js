...
const QUOTE_URLS = [
  "https://raw.githubusercontent.com/Tohidkhan6332/Islamic-Database/main/text/random_quotes.txt",
  "https://raw.githubusercontent.com/Tohidkhan6332/Islamic-Database/main/text/motivational_quotes.txt",
  "https://raw.githubusercontent.com/Tohidkhan6332/Islamic-Database/main/text/pickup_quotes.txt",
];
...
async function fetchQuotes() {
  try {
    ...
    if (allQuotes.length === 0) {
      ...
      return [
        "💎 By PUTTUS-AI - Your WhatsApp Bot",
...
function getRandomQuote(quotes) {
  if (!quotes || quotes.length === 0) return "💎 By PUTTUS-AI";
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (action === "set") {
        ...
        if (quoted) {
          customBio =
            quoted.conversation || quoted.extendedTextMessage?.text || null;
        } else {
