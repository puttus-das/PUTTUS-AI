  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      const res = await axios.get(
        "https://raw.githubusercontent.com/Tohidkhan6332/Database/main/images/cyberspace.json",
      );
      ...
      await sock.sendMessage(
        chatId,
        { image: { url: randomImage }, caption: "🌐 Cyberspace Image" },
        { quoted: message },
      );
    } catch (err) {
      ...
      await sock.sendMessage(
        chatId,
        { text: "❌ Error while fetching image." },
        { quoted: message },
      );
    }
  },
