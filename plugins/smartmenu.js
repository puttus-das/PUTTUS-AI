...
function getCategoryEmoji(category) {
  const emojis = categoryEmojis[category.toLowerCase()] || [
    "📂",
    "📁",
    "🗂️",
    "📋",
...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      const thumbnail = fs.existsSync(imagePath)
      ...
      let menuText = `${menuEmoji} *${settings.botName || "PUTTUS-AI"}* ${menuEmoji}\n\n`;
      menuText += `┏━━━━━━━━━━━━━━━━┓\n`;
      menuText += `┃ 📱 *Bot:* ${settings.botName || "PUTTUS-AI"}\n`;
      ...
      for (const cat of categories) {
        ...
        catCmds.forEach((cmdName, index) => {
          ...
          const isOff = CommandHandler.disabledCommands.has(
            cmdName.toLowerCase(),
          );
          const cmdStats = stats.find(
            (s) => s.command === cmdName.toLowerCase(),
          );
      ...
      const messageOptions = {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: settings.botName || "PUTTUS-AI",
            serverMessageId: -1,
          },
        },
      };
